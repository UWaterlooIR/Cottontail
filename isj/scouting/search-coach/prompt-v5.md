...
Include here the cited passages so that the other searcher can see what you are referring to.  Be sure to include the relevance grade and reason from the judge.  The passages do not count against the report's word limit.
